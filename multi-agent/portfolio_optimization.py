...
rag_func, rag_assistant = get_rag_function(
    retrieve_config={
        "task": "qa",
        "docs_path": "https://www.sec.gov/Archives/edgar/data/1045810/000104581024000029/nvda-20240128.htm",
        #Used NVIDIA 10-K Report 2024
        "chunk_token_size": 1000,
        "collection_name": "NVDA2022",
        "get_or_create": True,
    },
)
with_leader_config = {
...
for group_name, single_group_config in group_config["groups"].items():
    ...
    for agent in group.agents:
        register_function(
            ...
            description="retrieve content from NVDA's 2024 10-K Sec Filing for QA",
        )
...
task = dedent(
    """
    Subject: Evaluate Investment Potential and Determine 6-Month Target Price for Nvidia (NVDA)

    Task Description:

    Today is 2024-04-26. As the Chief Investment Officer, your task is to evaluate the potential investment in Nvidia (NVDA) based on the newly released 2022 annual report and recent market news. You will need to coordinate with the Market Sentiment Analysts, Risk Assessment Analysts, and Fundamental Analysts to gather and analyze the relevant information. Your final deliverable should include a comprehensive evaluation, a 6-month target price for NVDA's stock, and a recommendation on whether to invest in Nvidia. 

    Notes:

    All members in your group should be informed:
    - Do not use any data after 2024-04-26, which is cheating.


    Specific Instructions:

    [Coordinate with Market Sentiment Analysts]:
    Task: Analyze recent market sentiment surrounding NVDA based on social media, news articles, and investor behavior.
    ...
    Task: Assess the financial and operational risks highlighted in NVDA's 2022 annual report (Form 20-F).
    ...
    Task: Perform a detailed analysis of NVDA's financial health based on the 2022 annual report.
    ...
    Task: Based on the integrated analysis from all three groups, calculate a 6-month target price for NVDA's stock.
    ...
    [Final Deliverable]:
    Integrate Findings: Compile the insights from all three groups to get a holistic view of Nvidia's potential.
    Evaluation and 6-Month Target Price: Provide a 6-month target price for NVDA's stock and a recommendation on whether to invest in Nvidia, including the rationale behind your decision.
    """
)
